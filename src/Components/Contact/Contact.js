...
const Contact = () => {
  ...
  return (
    <div className="contact-wrapper-with-sidebar">
      ...
      <div className="contact-main">
        ...
        <div className="contact-info-cards">
          ...
          <div className="info-card tiktok">
            ...
            <h3>TikTok</h3>
            <a href="https://www.tiktok.com/@webtvgabon" target="_blank" rel="noopener noreferrer">
              @webtvgabon
            </a>
          </div>
          ...
          <div className="info-card location">
            ...
            <h3>Ville</h3>
            <p style={{color:'#FFA500', fontWeight:'bold'}} >Port‑Gentil, Gabon</p>
          </div>
        </div>
